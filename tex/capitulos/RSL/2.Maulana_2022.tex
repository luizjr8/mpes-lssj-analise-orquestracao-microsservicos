...
\begin{figure}
    ...
    \caption{Cenário descrito nos testes em \textcite{maulana_design_2022}}
...
\begin{table}[H]
\centering
\caption{Condições de carga e estresse. \cite{maulana_design_2022}}
...
\begin{figure}[htb]
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \caption{Throughput Cenário Monolítico. \cite{maulana_design_2022}}
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \caption{Throughput Cenário Microsserviços. \cite{maulana_design_2022}}
...
\begin{figure}[htb]
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \caption{Latência Cenário Monolítico. \cite{maulana_design_2022}}
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \caption{Latência Cenário Microsserviços. \cite{maulana_design_2022}}
