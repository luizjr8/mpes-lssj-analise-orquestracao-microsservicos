...
\begin{figure}[htb]
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \caption{Tempos de respostas dos microsserviços com dados Flat. \cite{niswar_performance_2024}}
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \caption{Tempos de respostas dos microsserviços com dados Aninhados. \cite{niswar_performance_2024}}
...
\begin{figure}[htb]
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \caption{Uso de CPU dos microsserviços com dados Flat. \cite{niswar_performance_2024}}
  ...
  \begin{minipage}[t]{0.48\linewidth}
    ...
    \caption{Uso de CPU dos microsserviços com dados Aninhados. \cite{niswar_performance_2024}}
