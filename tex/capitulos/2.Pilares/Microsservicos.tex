...
\begin{figure}[H]
    ...
    \caption{Arquitetura em microsserviços. \cite{fowler_microsservicos_2022}}
...
\begin{figure}[H]
    ...
    \caption{Fluxo de comunicação gRPC entre clientes (Go/Ruby) e um serviço gRPC. Fonte: \cite{google_grpc_nodate}.}
