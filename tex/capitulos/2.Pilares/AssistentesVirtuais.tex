...
\begin{figure}[H]
    ...
    \caption{Funcionamento simplificado de um assistente virtual. Fonte: \textcite{cruz_assistentes_2018}.}
...
\begin{figure}[H]
    ...
    \caption{Evolução dos modelos de conversação. Fonte: \cite{dsacademy_llms_2023} }
...
\subsection{Aplicações de Assistentes Virtuais Baseado em microsserviço no setor financeiro}
